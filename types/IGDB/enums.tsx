...
export enum IGDBExternalGameCategory {
    steam = 1,
    gog = 5,
    youtube = 10,
    microsoft = 11,
...
export enum IGDBExternalGameMedia {
    digital = 1,
    physical = 2
}
...
export enum IGDBPlatformWebsiteCategory {
    official = 1,
    wikia = 2,
    wikipedia = 3,
    facebook = 4,
